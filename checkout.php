	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Antrian</h3>
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="nomorhp" placeholder="Nomor HP">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="kendaraan" placeholder="Kendaraan">
							</div>
					...
					<div class="col-md-5 order-details">
						<div class="section-title text-center">
							<h3 class="title">Servis</h3>
						</div>
						<div class="order-summary">
							<div class="order-col">
								<div><strong>Servis</strong></div>
