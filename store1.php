			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="store1.php">Banjarmasin tengah</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$sql = "SELECT COUNT(ID_BENGKEL) as jumlah FROM bengkel WHERE KECAMATAN = 'Banjarmasin Tengah'";
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<?php
								...
								$limit = 18;
								$query = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Tengah'";
								...
								$show  = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Tengah' ORDER BY ID_BENGKEL  ASC LIMIT $starting_limit, $limit ";
