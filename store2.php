			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="store2.php">Banjarmasin timur</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$sql = "SELECT COUNT(ID_BENGKEL) as jumlah FROM bengkel WHERE KECAMATAN = 'Banjarmasin Timur'";
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<?php
								...
								$limit = 18;
								$query = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Timur'";
								...
								$show  = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Timur' ORDER BY ID_BENGKEL  ASC LIMIT $starting_limit, $limit ";
