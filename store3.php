			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="store3.php">Banjarmasin selatan</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$sql = "SELECT COUNT(ID_BENGKEL) as jumlah FROM bengkel WHERE KECAMATAN = 'Banjarmasin Selatan'";
					$statement = $pdo_conn->prepare("$sql");
					$statement->execute();
					$random = $statement->fetch();?>
							
							<li class="active">SEMUA ( <?php echo $random['jumlah']?> BENGKEL)</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<?php
								...
								$limit = 18;
								$query = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Selatan'";
								...
								$show  = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Selatan' ORDER BY ID_BENGKEL  ASC LIMIT $starting_limit, $limit ";
...
<div class="col-md-4 col-xs-12">
					<div class="product">
									...
									<div class="product-body">
										<h3 class="product-name"><a href="#"><?php echo $res["NAMA_BENGKEL"]; ?></a></h3>
										
										<div class="product-btns">
	
											<button class="quick-view"><a href="product.php?id=<?php echo $res['ID_BENGKEL']?>"><i class="fa fa-eye"><span class="tooltipp">Lihat Bengkel</i></a></button>
										</div>
									</div>
