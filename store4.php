			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="store4.php">Banjarmasin barat</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$sql = "SELECT COUNT(ID_BENGKEL) as jumlah FROM bengkel WHERE KECAMATAN = 'Banjarmasin Barat'";
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<?php
								...
								$limit = 18;
								$query = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Barat'";
								...
								$show  = "SELECT * FROM bengkel WHERE KECAMATAN = 'Banjarmasin Barat' ORDER BY ID_BENGKEL  ASC LIMIT $starting_limit, $limit ";
